...
const Keyboard = ({ play, sounds, power }) => /*#__PURE__*/
...
const DrumControl = ({ name, stop, power, volume, handleVolumeChange, changeSoundsGroup }) => /*#__PURE__*/
React.createElement("div", { className: "control" }, /*#__PURE__*/
React.createElement("button", { onClick: stop }, "Power ", power ? "OFF" : "ON"), /*#__PURE__*/
React.createElement("h2", null, "Vol: %", Math.round(volume * 100)), /*#__PURE__*/
...
React.createElement("button", { onClick: changeSoundsGroup }, "Switch Sound"));
...
const App = () => {
  ...
  const styleActiveKey = audio => {
    ...
    audio.parentElement.style.color = "grey";
  };
